...
export class ASTTreeElement extends HTMLElement {
  ...
  render(): SVGGraphicsElement {
    ...
    const subtrees =
      Array.from(
        this.querySelectorAll(":scope > ast-node") as NodeListOf<ASTExprElement>,
        subtree => {
...
export class ASTExprElement extends ASTTreeElement {
  constructor () { super(); }
  override connectedCallback() { }
}

customElements.define("ast-tree", ASTTreeElement);
customElements.define("ast-node", ASTExprElement);